...
title: "CMDA-4654"
subtitle: "Project 1"
author: "Spencer Paragas and Chris Mascis"
date: "10/19/2021"
output:
  pdf_document:
    highlight: haddock
...
```{r}
myfit <- myloess(ozone$temperature, ozone$ozone, span = 0.75, degree = 2)

for (i in seq(0.25, 0.75, by = 0.05)) {
  print(loess(ozone ~ temperature, ozone, span = i)$s)
}
loess(ozone ~ temperature, ozone, span = 0.75)$fit
